...
describe('Skill Analysis', () => {
  describe('extractSkillsFromProofs', () => {
    it('should extract unique skills from proofs', () => {
      ...
      expect(skills.length).toBe(10); // 10 unique skills
    });
  ...
  describe('analyzeSkills', () => {
    it('should return comprehensive skill analysis', () => {
      ...
      expect(analysis.totalSkills).toBe(10);
      expect(analysis.uniqueSkills).toBe(10);
      expect(analysis.skills.length).toBe(10);
      expect(analysis.topSkills.length).toBe(10);
